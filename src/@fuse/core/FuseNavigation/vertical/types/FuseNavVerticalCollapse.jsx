        ...
        {item.access && item.access.indexOf(role["role"]) > -1 && (
          ...
          >
            <ListItem
              ...
              button
              className="fuse-list-item list_block"
            ...
            >
              <div
                className={clsx(
                  "fuse-list-item-icon shrink-0 sidebar_menu_icon",
                  item.iconClass
                )}
                color="action"
              >
              ...
              <ListItemText
                ...
                classes={{
                  primary:
                    "text-13 font-medium fuse-list-item-text-primary truncate inner_menus",
                  secondary:
                    "text-11 font-medium fuse-list-item-text-secondary leading-normal truncate inner_menus",
                }}
              />
              ...
              <IconButton
                disableRipple
                className="w-20 h-20 -mx-12 p-0 focus:bg-transparent hover:bg-transparent icon_button"
